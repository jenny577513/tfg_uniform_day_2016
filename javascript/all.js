...
$dragger = $('#dragger'),
$usersizer = $('#user-size-slider'),
$coversizer = $('#cover-size-slider'),
$loading = $('#loading');
$uploading = $('#uploading');
...
$(document).ready(function()
{
  ...
  $("#normalSubmit").click(function() {
    ...
    usersize = getBackgroundSize($userimage.css('background-size')),
    coversize = getBackgroundSize($coverimage.css('background-size')),
    userposition = getBackgroundPosition($userimage.css('background-position')),
    coverposition = getBackgroundPosition($coverimage.css('background-position')),
    scale = basesize/500;
    ...
    w = usersize[0]/scale,
    h = usersize[1]/scale,
    x = userposition[0]/scale,
    y = userposition[1]/scale,
    w2 = coversize[0]/scale,
    h2 = coversize[1]/scale,
    x2 = userposition[0]/scale,
    y2 = userposition[1]/scale;
